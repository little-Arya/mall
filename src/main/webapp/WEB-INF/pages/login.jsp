...
<table width="100%" border=1>
    ...
    <c:forEach items="${login}" var="account">
        <tr>
            <td>${account.id}</td>
            <td> ${account.name}</td>
            <td>${account.price }</td>
            <td> <img id="images" src="/upload/${account.img }"></td>
            <td>${account.detail }</td>
            <td><a href="${pageContext.request.contextPath}/update?id=${account.id }">修改</a></td>
            <td><a href="deleteItemById?id=${account.id }">删除</a></td>
        </tr>
    </c:forEach>
</table>
